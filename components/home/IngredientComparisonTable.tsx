          ...
          <table className="w-full min-w-[420px] text-sm">
            <thead>
              <tr className="bg-[#F5F0E8]">
                <th className="text-left py-4 px-5 font-bold text-[#1C1C1C] w-1/2">Ingredient</th>
                <th className="text-center py-4 px-5 font-bold text-[#2D5016]">
                  Hardin Organics
                </th>
                <th className="text-center py-4 px-5 font-bold text-[#6B6B6B]">
                  Regular Soap
                </th>
              </tr>
            </thead>
            <tbody>
              {rows.map((row, i) => (
                ...
                >
                  <td className="py-3.5 px-5 text-[#1C1C1C] font-medium">{row.ingredient}</td>
